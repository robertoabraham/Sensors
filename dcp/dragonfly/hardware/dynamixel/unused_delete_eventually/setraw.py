...
if len(sys.argv) != 2:
    print("Need to input an angle to tilt to. Example: python setraw.py 185")
    exit()
raw_dxl_goal_angle = (float(sys.argv[1]) )
dxl_goal_angle = float(sys.argv[1]) - zeropoint_angle
dxl_goal_position = int(round((dxl_goal_angle)*(bits/360)))
...
# print("     goal_raw_angle:%.2f  raw_angle:%.2f" % (dxl_goal_angle, (360*dxl_present_position/bits)))
